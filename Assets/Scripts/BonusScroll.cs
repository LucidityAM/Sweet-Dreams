...
public class BonusScroll : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (deltaT > 0 && deltaT < 1)
        {
            ...
            run = false;
            targetPlayer.GetComponent<BonusControl>().moveForce = 0;
            targetPlayer.GetComponent<BonusControl>().jumpForce = 0;
        ...
        if (deltaT > 4 && deltaT < 4.1f)
        {
            ...
            run = true;
            targetPlayer.GetComponent<BonusControl>().moveForce = 8;
            targetPlayer.GetComponent<BonusControl>().jumpForce = 7;
            targetPlayer.GetComponent<PlayerStats>().energy = 20;
        ...
        if (run == true)
        {
            ...
            step = .15f;
            MCamera.GetComponent<BonusScroll>().enabled = true;
