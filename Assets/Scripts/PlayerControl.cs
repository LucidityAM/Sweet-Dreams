...
public class PlayerControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (dream == 1)
        {
            dreams.text = "1/9".ToString();
        }
        if (dream == 2)
        {
            dreams.text = "2/9".ToString();
        }
        if (dream == 3)
        {
            dreams.text = "3/9".ToString();
        }
        if (dream == 4)
        {
            dreams.text = "4/9".ToString();
        }
        if (dream == 5)
        {
            dreams.text = "5/9".ToString();
        }
        if (dream == 6)
        {
            dreams.text = "6/9".ToString();
        }
        if (dream == 7)
        {
            dreams.text = "7/9".ToString();
        }
        if (dream == 8)
        {
            dreams.text = "8/9".ToString();
        }
        if (dream == 9)
        {
            dreams.text = "9/9".ToString();
        }
